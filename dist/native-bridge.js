...
async function startNative(){
 const [{Capacitor},{AdMob,AdmobConsentStatus},{Purchases}]=await Promise.all([import('@capacitor/core'),import('@capacitor-community/admob'),import('@revenuecat/purchases-capacitor')]);
